...
// ---------------- SERVICES ----------------
            ...
            // ---------------- FULL-SECTION BODIES (edit/update/delete via Page Content) ----------------
            ...
            ['services', 'Pillars', 'invest_body', 'Investment Solutions full body (HTML)', 'textarea', '<p class="svch-desc">This part of my practice focuses on investment execution and product access for individuals and professionals building, maintaining or reviewing their investment holdings.</p><p>As a SEBI-registered Mutual Fund Distributor, I help clients access and execute a range of investment products. This is a distribution and execution service, not a personalised investment advisory service.</p><ul class="svch-list"><li>Mutual funds</li><li>Fixed deposits, corporate bonds and NCDs</li><li>GIFT City investment products and related offerings</li><li>Other investment products, where available</li></ul>', 2],
            ['services', 'Pillars', 'tax_body', 'Taxation & Compliance full body (HTML)', 'textarea', '<p class="svch-desc">Tax and compliance work is recurring, deadline-driven and detail-sensitive. This part of my practice supports individuals, professionals and businesses with tax planning, return filing or GST compliance.</p><ul class="svch-list"><li><strong>Tax Planning</strong> — Helping individuals and professionals think through their tax outgo more deliberately, within the framework of applicable laws and provisions.</li><li><strong>Income Tax Return Filing</strong> — Preparation and filing of income tax returns, including review of the documents and information the process requires.</li><li><strong>GST Registration</strong> — Support with GST registration for businesses and professionals who need to register under the applicable framework.</li><li><strong>GST Return Filing &amp; Support</strong> — Ongoing GST return filing and compliance support, tailored to the nature of the business and its reporting obligations.</li></ul>', 3],
            ['services', 'Pillars', 'finorg_body', 'Financial Organisation full body (HTML)', 'textarea', '<p class="svch-desc">Not every financial need fits under investing or taxation. Sometimes the need is more practical — organising records, pulling together scattered information, or having dependable support for recurring financial tasks.</p><p>This part of my work focuses on improving visibility over documents and accounts, coordinating routine financial tasks, and helping clients stay on top of the administrative side of their finances.</p>', 4],
            ['insights', 'Topics', 'topics_list', 'Topics list (HTML)', 'textarea', '<ul><li>Retirement planning and retirement preparedness</li><li>Investing and long-term wealth creation</li><li>Tax planning and income tax-related topics</li><li>Insurance, borrowing and other everyday financial decisions</li><li>Personal finance concepts explained in simple, practical terms</li></ul>', 2],
            ['media', 'Appearances', 'appearances_title', 'Appearances title', 'text', 'Media Appearances', 1],
            ['media', 'Appearances', 'appearances', 'Appearances body (HTML)', 'textarea', '<p>My work has also extended into interviews, television segments and platform conversations — covering financial education, retirement planning, investing and current financial topics.</p><p>This page is the home for those appearances across video, audio, and interview formats.</p>', 2],
            ['books', 'Featured Book', 'feat_paras', 'Featured book paragraphs (HTML)', 'textarea', '<p>My first book is centred on one of the most significant transitions in financial life: retirement.</p><p>Retirement is often discussed in terms of corpus targets and investment returns. Those matter — but retirement also raises questions a calculator cannot fully answer: identity, health, family responsibilities, routine, uncertainty, purpose and what life looks like once work is no longer at the centre of it.</p><p>This book brings those conversations together in one place, combining financial planning with the wider realities that shape retirement.</p>', 2],
            ['books', 'Why & Covers', 'why_paras', 'Why I wrote this book (HTML)', 'textarea', '<p>Retirement planning is often treated too narrowly — as though the only real question is whether the corpus will be enough.</p><p>In reality, it brings together a much wider set of concerns: income, longevity, health costs, emotional adjustment, changing family roles and the uncertainty of what life after work may look like.</p><p>I wanted to write a book that engages with these questions honestly, without losing sight of the financial foundations that still matter.</p>', 1],
            ['testimonials', 'Experiences', 'exp_title', 'Experiences title', 'text', 'Client Experiences', 1],
            ['testimonials', 'Experiences', 'exp', 'Experiences body (HTML)', 'textarea', '<p>Every client’s need is different — some come for investment support, some for tax or GST work, some for financial documentation, and many for a mix of these over time.</p><p><em>Client testimonials will be added here soon.</em></p>', 2],
            ['testimonials', 'Hope', 'hope_title', 'Hope title', 'text', 'What I Hope the Experience Reflects', 1],
            ['testimonials', 'Hope', 'hope', 'Hope body (HTML)', 'textarea', '<p>Beyond technical help, I want clients to feel reliability, responsiveness and confidence that their matters are being handled with care. That’s what I hope this page will reflect, once it’s live.</p>', 2],
            // ---------------- SETTINGS ----------------
