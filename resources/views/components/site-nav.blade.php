@php
    ...
    $isPractice = request()->routeIs('about') || request()->routeIs('services');
    $links = $isPractice
        ? [
...
<header class="site-header">
    <div class="container nav-shell">
        @if ($isPractice)
            <a href="{{ route('home') }}" class="brand-image-lockup" aria-label="Money Maze home">
                <img src="{{ asset('assets/money-maze-logo.jpg') }}" alt="Money Maze — Paving Your Financial Path">
            </a>
        @else
